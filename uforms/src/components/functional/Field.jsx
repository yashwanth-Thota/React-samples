...
export default function Field(props){
    ...
    return (
        <div style={{width:'35vw'}}>
           <label style={{float:'left',width:'15vw',left:'0',marginRight:'3vw'}}>{props.label}<span style={reqStyle}>{props.required?"*":''}</span></label>
           {
               props.type=='dropdown'?
           ...
           <br/>
           <ValidationError errorRef={errorRef} message={props.errorMsg}/>
           {props.children}
        </div>
    )   
}